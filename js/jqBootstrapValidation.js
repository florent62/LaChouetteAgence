    ...
    var defaults = {
                ...
                return this.each(function() {
                    ...
                    if (settings.options.sniffHtml) {
                        ...
                        if ($this.attr("type") !== undefined && $this.attr("type").toLowerCase() === "email") {
                            message = "Veuillez saisir une adresse e-mail valide<!-- data-validator-validemail-message to override -->";
        ...
        builtInValidators: {
            ...
            required: {
                name: "Required",
                type: "required",
                message: "Le champs est requis<!-- data-validator-required-message to override -->"
            },
            checkone: {
                name: "Checkone",
                type: "minchecked",
